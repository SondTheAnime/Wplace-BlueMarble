...
const templateGallery = new TemplateGallery(templateManager, overlay); // Constructs a new TemplateGallery object
...
function buildOverlayMain() {
  ...
  overlay.addDiv({ 'id': 'bm-overlay', 'style': 'top: 10px; right: 75px;' })
    ...
    .addButton({ 'id': 'bm-button-gallery', 'className': 'bm-help', 'innerHTML': '📁', 'title': 'Template Gallery' },
      (instance, button) => {
